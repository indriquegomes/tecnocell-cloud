-- ============================================================
-- Endereço em pessoas + número sequencial de venda
-- Gerado em 2026-06-23
-- RODAR NO: Supabase Dashboard > SQL Editor > New query > Run
-- ============================================================

-- 1. Campos de endereço em pessoas
ALTER TABLE pessoas
...
-- 2. Sequence para número de venda (esqueleto — usado pelo RPC abaixo)
CREATE SEQUENCE IF NOT EXISTS venda_numero_seq START 1;

-- 3. Coluna numero em vendas (NULL em vendas antigas; novas populadas pelo RPC)
ALTER TABLE vendas ADD COLUMN IF NOT EXISTS numero integer;

-- ============================================================
-- 4. Atualizar finalizar_venda para usar nextval + retornar numero
-- ============================================================
