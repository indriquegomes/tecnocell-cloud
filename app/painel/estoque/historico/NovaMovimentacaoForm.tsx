...
const OP_LABEL: Record<string, string> = { entrada: 'Entrada', saida: 'Saída', ajuste: 'Ajuste', perda: 'Perda', uso_interno: 'Uso interno' }
const OP_CLS: Record<string, string> = {
  ...
  uso_interno: 'text-purple-700 bg-purple-50 border-purple-200',
}
