...
export default async function ConfiguracoesPage({ searchParams }: { searchParams: Promise<{ erro?: string; ok?: string }> }) {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      {ok && <div className="rounded-xl border border-green-200 bg-green-50 px-4 py-3 text-sm text-green-700">Configurações salvas com sucesso!</div>}

      <form action={salvarConfiguracoes} className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm space-y-5">
