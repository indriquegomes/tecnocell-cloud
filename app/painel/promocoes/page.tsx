      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <form action={criarPromocao} className="grid gap-4 sm:grid-cols-2">
          ...
          <div>
            ...
            <select name="tipo" className="field w-full">
          ...
          <div>
            <label className="mb-1.5 block text-xs font-semibold uppercase text-gray-500">Valor geral (para Leve/Acima)</label>
            <input name="valor" type="number" step="0.01" min="0" defaultValue="0" className="field w-full" placeholder="0" />
          </div>
          <div>
