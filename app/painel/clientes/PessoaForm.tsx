    ...
    <form action={action} className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm space-y-6">
      ...
      <div>
        ...
        <div className="grid gap-5 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2 rounded-xl border border-gray-200 bg-gray-50/60 p-3">
            <label className="flex items-center gap-2 text-sm font-medium text-gray-700">
              <input type="hidden" name="permite_fiado" value="0" />
              <input type="checkbox" name="permite_fiado" value="1" defaultChecked={!!editando?.permite_fiado}
                className="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500" />
              🤝 Permite vender no fiado (Crédito Loja)
            </label>
            <p className="mt-1 text-[11px] text-gray-400">Só quem tem esta caixa marcada consegue comprar fiado. Os outros são bloqueados no PDV.</p>
          </div>
          <div>
