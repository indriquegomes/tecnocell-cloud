...
export default async function NovaClientePage({ searchParams }: { searchParams: Promise<{ erro?: string }> }) {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <form action={criarPessoa} className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm space-y-5">
        <div className="grid gap-5 sm:grid-cols-2">
          <div className="sm:col-span-2">
            <label className="mb-1.5 block text-sm font-medium text-gray-700">Nome / Razão Social *</label>
            <input name="nome" required className="field" placeholder="Nome completo ou razão social" />
          </div>
          <div>
          ...
          <div>
            ...
            <select name="pessoa_fisica" className="field">
          ...
          <div>
            ...
            <input name="cpf_cnpj" className="field" placeholder="000.000.000-00" />
          </div>
          <div>
          ...
          <div className="sm:col-span-2">
            ...
            <input name="email" type="email" className="field" placeholder="email@exemplo.com" />
          </div>
          <div>
