...
(async () => {
  ...
  // scroll para ver o breakdown completo
  await page.evaluate(() => window.scrollBy(0, 400));
  await page.waitForTimeout(300);
  await page.screenshot({ path: 'C:/Users/usuario/projetos/tecnocell-cloud/sige-screenshots/fechamento-formas-scroll.png', fullPage: false });
  console.log('OK');
  await browser.close();
})();
