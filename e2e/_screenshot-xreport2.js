...
(async () => {
  ...
  await page.click('button:has-text("Relatório X")');
  await page.waitForTimeout(800);
  await page.screenshot({ path: 'C:/Users/usuario/projetos/tecnocell-cloud/sige-screenshots/xreport-full.png', fullPage: true });
  console.log('OK');
  await browser.close();
})();
