...
(async () => {
  ...
  await page.screenshot({ path: 'C:/Users/usuario/projetos/tecnocell-cloud/sige-screenshots/reforco-panel.png' });

  // Abre painel retirada
  await page.click('button:has-text("Retirada")');
  await page.waitForTimeout(600);
  await page.screenshot({ path: 'C:/Users/usuario/projetos/tecnocell-cloud/sige-screenshots/retirada-panel.png' });
