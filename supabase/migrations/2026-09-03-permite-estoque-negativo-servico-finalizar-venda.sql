-- finalizar_venda: pula a trava de estoque pra produto com permite_estoque_negativo
-- (serviço). Resto do corpo idêntico a 2026-08-28-retirada-entrega-venda.sql.
