    ...
    <div className={cn('fixed bottom-6 right-6 z-50', className)}>
      ...
      {!open && (
        <button
          ...
          className="flex h-14 w-14 items-center justify-center rounded-full bg-white shadow-lg ring-1 ring-gray-200 transition hover:scale-105"
          aria-label="Abrir assistente"
        >
          <img src="/tecnocell-icon.png" alt="Assistente TecnoCell" className="h-9 w-9 object-contain" />
        </button>
      )}
